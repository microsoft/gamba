...
def main():
    ...
    p.add_argument("--genome_fasta", default="/data_processing/data/240-mammalian/hg38.ml.fa")
    p.add_argument("--gtf_dir", default="/data_processing/data/for_sampling/gtfs/")
    p.add_argument("--vista_tsv", default="data_processing/data/for_sampling/VISTA_enhancers/subsets/vista_human_positive.tsv")
    p.add_argument("--promoters_bed", default="data_processing/data/for_sampling/promoters/promoters.bed")
    p.add_argument("--utr5_bed", default="data_processing/data/for_sampling/UCSC coordinates/UCSC_5UTR_exons.bed")
    p.add_argument("--utr3_bed", default="data_processing/data/for_sampling/UCSC coordinates/UCSC_3UTR_exons.bed")
    p.add_argument("--repeats_bed", default="data_processing/data/for_sampling/repeats_hg38.bed")
    p.add_argument("--ucne_bed", default="data_processing/data/for_sampling/hg38_UCNE_coordinates.bed")
    p.add_argument("--ucne_paralogues", default="data_processing/data/for_sampling/conserved_elements/ucne_paralogues.txt")
    p.add_argument("--output_dir",  default="data_processing/data/regions")
